...
*/
include_once('videoconverter-InstallIndicator.php');

class videoconverter_LifeCycle extends videoconverter_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToPluginsMenu() {
        ...
        add_submenu_page('plugins.php',
                         ...
                         array(&$this, 'settingsPage', '/img/icon.png'));
    }
